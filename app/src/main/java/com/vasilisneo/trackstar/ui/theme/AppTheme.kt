...
// subscription-gated tiers (locked until there's a subscription system).
enum class AppTheme(
    val id: String,
    ...
    BRONZE("bronze", "Bronze", Color(0xFFD98436), 0.65f, locked = true),
    SILVER("silver", "Silver", Color(0xFFD1D6EB), 0.65f, locked = true),
    GOLD("gold", "Gold", Color(0xFFFFBE2E), 0.65f, locked = true);
