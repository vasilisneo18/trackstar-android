...
// that isn't reproduced here (imePadding + a plain scrollable Column handles keyboard
// avoidance instead); every other visual detail (backgrounds, fields, buttons, spacing,
// error message) matches exactly. See RegistrationHelpers.swift for the source values.
